...
- **kernel-module-glowforge**, the kernel driver for motion, the laser latch, the safety readbacks, and the sensors. GPL-2.0-or-later. Copyright 514 LLC d/b/a OpenGlow and Glowforge, Inc. The inherited factory module was written by Matt Sarnoff with contributions from Taylor Vaughn.
